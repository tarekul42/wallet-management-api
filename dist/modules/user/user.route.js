...
router.get("/me", (0, checkAuth_1.default)(user_interface_1.Role.USER, user_interface_1.Role.ADMIN, user_interface_1.Role.AGENT, user_interface_1.Role.SUPER_ADMIN), rateLimiter_1.selfActionLimiter, user_controller_1.UserControllers.getMyProfile);
router.patch("/me", (0, checkAuth_1.default)(user_interface_1.Role.USER, user_interface_1.Role.ADMIN, user_interface_1.Role.AGENT, user_interface_1.Role.SUPER_ADMIN), rateLimiter_1.selfActionLimiter, user_controller_1.UserControllers.updateMyProfile);
...
router.post("/create-admin", (0, checkAuth_1.default)(user_interface_1.Role.SUPER_ADMIN), rateLimiter_1.adminActionLimiter, (0, validateRequest_1.validateRequest)(user_validation_1.createAdminZodSchema), user_controller_1.UserControllers.createAdmin);
