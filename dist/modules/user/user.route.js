...
router.post("/create-admin", (0, checkAuth_1.default)(user_interface_1.Role.SUPER_ADMIN), (0, validateRequest_1.validateRequest)(user_validation_1.createAdminZodSchema), user_controller_1.UserControllers.createAdmin);
