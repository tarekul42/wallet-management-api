...
const agentApprovalByAdmin = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const suspendAgent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.UserServices.suspendAgent(id, status);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
        message: `Agent has been successfully ${(status === null || status === void 0 ? void 0 : status.toLowerCase()) || "updated"}.`,
        data: result,
    });
}));
